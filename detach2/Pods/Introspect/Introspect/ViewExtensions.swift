...
extension View {
    ...
    public func introspect<TargetView: UIView>(
        ...
        customize: @escaping (TargetView) -> Void) -> some View
    {
    ...
    public func introspectTableView(customize: @escaping (UITableView) -> Void) -> some View {
        introspect(selector: TargetViewSelector.ancestorOrSibling, customize: customize)
    }
    ...
    public func introspectTextField(customize: @escaping (UITextField) -> Void) -> some View {
        introspect(selector: TargetViewSelector.sibling, customize: customize)
    }
